...
const SearchHeader = ({ selected }: Props) => {
  ...
  return (
    <header className="sticky top-0 left-0 bg-white flex flex-row py-auto items-center justify-center gap-6 px-2 md:px-0">
      <h1 className="text-3xl lg:text-7xl">MM Searchbar</h1>
      <form
        onSubmit={search}
